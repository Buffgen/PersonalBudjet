...
Begin
    ...
    If ComboBoxAction.ItemIndex = 0 then
    Begin
...
Begin
    ...
    FillChartTabAccounts(FormJournal.StringGridChartAcoountsTemp, FormMain.StringGridAccounts.Cells[AccountsColAccount, FormMain.StringGridAccounts.Row], YearNow);
    ComboBoxAction.ItemIndex := -1;
    ComboBoxAccount.ItemIndex := -1;
    ComboBoxCategory.ItemIndex := -1;
    EditAmount.Clear;
