...
Uses
    ...
    Vcl.ComCtrls, DateUtils, Vcl.ExtCtrls, Vcl.Buttons;
...
Type
    ...
    procedure ComboBoxOperationKeyPress(Sender: TObject; var Key: Char);
    procedure ComboBoxAmountKeyPress(Sender: TObject; var Key: Char);
    procedure ComboBoxDateKeyPress(Sender: TObject; var Key: Char);
    procedure ComboBoxDateKeyDown(Sender: TObject; var Key: Word;
      Shift: TShiftState);
    procedure ComboBoxOperationKeyDown(Sender: TObject; var Key: Word;
      Shift: TShiftState);
    procedure ComboBoxAmountKeyDown(Sender: TObject; var Key: Word;
      Shift: TShiftState);
...
Begin
    ...
    If Not CheckBoxAccount.Checked then
        EditAccount.Clear;

    If Not CheckBoxCategory.Checked then
        EditCategory.Clear;

    If Not CheckBoxAmount.Checked then
    Begin
        EditAmountFirst.Clear;
        EditAmountSecond.Clear;
        EditAmountFirst.Visible := False;
        EditAmountSecond.Visible := False;
        ComboBoxAmount.ItemIndex := -1;
        ComboBoxAmount.Visible := False;
    End;

    If Not CheckBoxDate.Checked then
    Begin
        ComboBoxDate.ItemIndex := -1;
        DateTimePickerFirst.Date := Now;
        DateTimePickerSecond.Date := Now;
        DateTimePickerFirst.Visible := False;
        DateTimePickerSecond.Visible := False;
    End;

    If Not CheckBoxComment.Checked then
    Begin
        EditComment.Clear
    End;
...
Procedure TFormFilterJournal.SpeedButtonResetClick(Sender: TObject);
Begin
    EditAccount.Clear;
...
Procedure TFormFilterJournal.ButtonExitClick(Sender: TObject);
Begin
    Close();
End;


Procedure TFormFilterJournal.ComboBoxAmountChange(Sender: TObject);
Begin
    If ComboBoxAmount.ItemIndex = 3 then
    Begin
        EditAmountFirst.Enabled := True;
        EditAmountFirst.Visible := True;
        EditAmountFirst.Clear;

        EditAmountSecond.Enabled := True;
        EditAmountSecond.Visible := True;
        EditAmountSecond.Clear;
    End
    Else
    Begin
        ...
        EditAmountSecond.Enabled := False;
        EditAmountSecond.Visible := False;
        EditAmountSecond.Clear;
    End;
End;
...
Procedure TFormFilterJournal.ComboBoxDateChange(Sender: TObject);
Begin
    If ComboBoxDate.ItemIndex = 3 then
        Begin
        DateTimePickerFirst.Enabled := True;
        DateTimePickerFirst.Visible := True;

        DateTimePickerSecond.Enabled := True;
        DateTimePickerSecond.Visible := True;
...
Procedure TFormFilterJournal.ComboBoxOperationChange(Sender: TObject);
Begin
    If ComboBoxOperation.ItemIndex >= 0 then
        ComboBoxAmount.Visible := True
    Else
        ComboBoxAmount.Visible := False;
End;


Procedure TFormFilterJournal.ComboBoxDateKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
Begin
...
Procedure TFormFilterJournal.ComboBoxDateKeyPress(Sender: TObject; var Key: Char);
Begin
    Key := #0;
End;


Procedure TFormFilterJournal.ComboBoxOperationKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
Begin
    If Key = VK_Delete then Key:=0;
End;


Procedure TFormFilterJournal.ComboBoxOperationKeyPress(Sender: TObject; var Key: Char);
Begin
    Key := #0;
End;


Procedure TFormFilterJournal.ComboBoxAmountKeyDown(Sender: TObject;
...
Procedure TFormFilterJournal.ComboBoxAmountKeyPress(Sender: TObject; var Key: Char);
Begin
    Key := #0;
End;
...
//==============================================================================
Procedure TFormFilterJournal.ButtonAddClick(Sender: TObject);
Var
    StringMatrix: TStringMatrix;
Begin
    SetLength(StringMatrix, 0, 0);
