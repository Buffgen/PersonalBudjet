...
Uses
    ...
    Function ActionOneMonthInYear(Var StringGridJournal: TStringGrid; InputAccount, InputYear, InputMonth: String): TStringMatrix;
...
Begin
    ...
    StringMatrix := StringMatch(StringGridJournal, InputAccount);
    DataFromMatrixToGrid(StringGridJournal, StringMatrix);
    StringMatrix := MonthAndYearEquals(StringGridJournal, InputYear, InputMonth);
    DataFromMatrixToGrid(StringGridJournal, StringMatrix);
    StringMatrix := FillMatrixMonthsInYear(StringGridJournal);
    ActionOneMonthInYear := StringMatrix;
End;
